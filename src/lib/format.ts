...
// Prazo é um dia, não um instante: só atrasa quando o dia já passou (não ao meio-dia do próprio dia).
...
export function dueLabel(value: Date): string {
...
export function daysSince(value: Date): number {
